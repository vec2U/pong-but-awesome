...
export class Ball {
  constructor(
    ...
    this.size = { x: 16, y: 16 }; // default ball size
    ...
    this.maximum = { x: 15, y: 15 }; //maximum speed
    this.inertialTransfer = 0.35; //multiplier for velocity.y transfer from paddle
    this.htmlElement = null; //element on HTML page
  }
}
...
export class Paddle {
  constructor(
    ...
    this.speed = 20; //rate that paddle moves with keyboard
